...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const handleRestore = async () => {
    const confirmRestore = window.confirm("Are you sure you want to restore default medicines? This will upsert them into the database catalog.");
        ...
        <div className="modal-body">
          <div className="settings-tab-content grid-split">
            ...
            <div className="medicine-list-col">
              ...
              {isConnected && (
                <div className="restore-defaults-box" style={{ marginBottom: "12px", padding: "10px", borderRadius: "6px", backgroundColor: "rgba(16, 185, 129, 0.08)", border: "1px solid rgba(16, 185, 129, 0.2)", display: "flex", gap: "10px", alignItems: "center" }}>
                  <button
                    type="button"
                    className="btn btn-secondary btn-sm"
                    style={{ fontSize: "11px", padding: "4px 8px", backgroundColor: "#10b981", color: "#ffffff", border: "none", whiteSpace: "nowrap", flexShrink: 0 }}
                  ...
                  <span style={{ fontSize: "11px", color: "#065f46" }}>
                    Restore missing default medicines to your Supabase catalog without deleting custom ones.
                  </span>
                </div>
              )}
