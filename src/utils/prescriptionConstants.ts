...
export const HEADER_HEIGHT_PX  = 130;   // measure from current .letterhead-header
export const PATIENT_HEIGHT_PX = 72;    // .page-patient fixed reservation
export const BOTTOM_HEIGHT_PX  = 160;   // signature + banner + footer combined
